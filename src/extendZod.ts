...
const mergeOpenApi = (openapi: ZodOpenApiMetadata, { ref: _ref, refType: _refType, param: _param, header: _header, ...rest }: ZodOpenApiMetadata = {}) => ({
  ...rest,
  ...openapi,
});
...
export function extendZodWithOpenApi(zod: typeof z) {
  ...
  zod.ZodType.prototype.openapi = function (openapi) {
    ...
    const result = new (this as any).constructor({
      ...rest,
      zodOpenApi: {
        openapi: mergeOpenApi(openapi as unknown as ZodOpenApiMetadata, zodOpenApi?.openapi),
      },
    });
  ...
  zod.ZodObject.prototype.extend = function (...args: [augmentation: ZodRawShape]) {

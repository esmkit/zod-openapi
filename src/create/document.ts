...
export interface ZodOpenApiOperationObject
  extends Omit<oas31.OperationObject & oas30.OperationObject, "requestBody" | "responses" | "parameters" | "callbacks"> {
...
export interface ZodOpenApiPathItemObject
  extends Omit<oas31.PathItemObject & oas30.PathItemObject, "get" | "put" | "post" | "delete" | "options" | "head" | "patch" | "trace"> {
...
export interface ZodOpenApiComponentsObject
  extends Omit<oas31.ComponentsObject & oas30.ComponentsObject, "schemas" | "responses" | "requestBodies" | "headers" | "parameters"> {
...
export const createDocument = (zodOpenApiObject: ZodOpenApiObject, documentOptions?: CreateDocumentOptions): oas31.OpenAPIObject => {
  ...
  const createdWebhooks = createPaths(webhooks, defaultComponents, documentOptions);
  const createdComponents = createComponents(components, defaultComponents, documentOptions);

...
import type { ZodOpenApiCallbackObject, ZodOpenApiRequestBodyObject, ZodOpenApiResponseObject } from "./document";
...
describe("getDefaultComponents", () => {
  ...
  it("returns manual components", () => {
    ...
    expect(result.requestBodies.get(eRequestBody)).toStrictEqual(expectedRequestBodies);

...
import { type CreateDocumentOptions, type ZodOpenApiCallbackObject, type ZodOpenApiObject, createDocument } from "./document";
...
`);
  ...
  it("Supports circular schemas declared in components.schemas", () => {
    ...
    const PartialPostSchema2: ZodType<Partial<Post2>> = (PostSchema2 as any).partial();
    ...
    const PartialUserSchema2: ZodType<Partial<User2>> = (UserSchema2 as any).partial();

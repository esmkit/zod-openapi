...
export const createNullableSchema = <T extends ZodTypeAny>(zodNullable: ZodNullable<T>, state: SchemaState): Schema => {
...
const mapNullType = (type: oas31.SchemaObject["type"]): oas31.SchemaObject["type"] => {
  if (!type) {
    return "null";
  }

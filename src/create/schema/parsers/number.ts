...
export const createNumberSchema = (zodNumber: ZodNumber, state: SchemaState): Schema => {
...
export const mapMultipleOf = (zodNumberCheck: ZodNumberCheckMap): Pick<oas31.SchemaObject | oas30.SchemaObject, "multipleOf"> | undefined =>
  zodNumberCheck.multipleOf ? { multipleOf: zodNumberCheck.multipleOf.value } : undefined;

export const mapMaximum = (
  zodNumberCheck: ZodNumberCheckMap,
  openapi: ZodOpenApiVersion,
): Pick<oas31.SchemaObject | oas30.SchemaObject, "maximum" | "exclusiveMaximum"> | undefined => {
...
export const mapMinimum = (
  zodNumberCheck: ZodNumberCheckMap,
  openapi: ZodOpenApiVersion,
): Pick<oas31.SchemaObject | oas30.SchemaObject, "minimum" | "exclusiveMinimum"> | undefined => {
...
const mapNumberType = (zodNumberChecks: ZodNumberCheckMap): oas31.SchemaObject["type"] => (zodNumberChecks.int ? "integer" : "number");
